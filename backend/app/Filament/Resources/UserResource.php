                ...
                Action::make('approveMember')
                    ...
                    ->action(function (User $record) {
                        ...
                        try {
                            ...
                            $record->notifyMember(
                                "Membership Approved",
                                "AssalÄmu â€˜alaykum {$record->name}, your membership has been approved. You can now log in to the app.",
                ...
                Action::make('approveNursingMotherGrace')
                    ...
                    ->action(function (User $record) {
                        ...
                        $record->notifyMember(
                            ...
                            "AssalÄmu â€˜alaykum, your nursing mother grace application has been approved. You are exempt from attendance fines until " . $record->nursing_mother_grace_until->toDateString() . ".",
