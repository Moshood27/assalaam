...
<head>
    ...
    <title>New Pregnancy Grace Request</title>
    <style>
...
<div class="wrapper">
    <div class="container">
        <div class="header">
            <p class="brand">{{ config('app.name') }} • New Pregnancy Grace Request</p>
        </div>
        <div class="content">
            <p>A member has applied for pregnancy/postpartum grace. Please review the medical proof and approve or reject the request.</p>
            ...
            <hr class="hr" />
            <p class="muted">Open the admin dashboard → Members → Pregnancy Grace to review this request.</p>
        </div>
        <div class="footer">
