...
@section('content')
    ...
    <div class="prose dark:prose-invert max-w-none space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
        <section>
            ...
            <p>
                <span class="font-bold text-primary-600 uppercase tracking-tight">AS-SALAAM OSOGBO ISLAMIC CICU LTD</span> (RC Number: 9518505) is a premier Islamic Cooperative Investment and Credit Union. We operate on the principles of Sharia, providing a viable alternative to conventional interest-based financial systems.
            </p>
        </section>
