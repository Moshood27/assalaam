<template>
  <div class="min-h-screen flex items-center justify-center bg-slate-50 p-6">
    <div class="bg-white p-8 rounded-2xl shadow-sm text-center max-w-sm w-full">
      ...
      <h1 class="text-xl font-bold text-slate-800 mb-2">Processing Wallet Top-up</h1>
      <p class="text-sm text-slate-500">Reference: {{ reference || 'N/A' }}</p>
      <p class="text-xs text-slate-400 mt-2">You will be redirected to your wallet shortly…</p>
    </div>
  </div>
</template>
