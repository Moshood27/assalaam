<template>
  <div class="min-h-screen bg-slate-50 pb-24">
    ...
    <div class="p-4 space-y-4 max-w-3xl mx-auto">
      <div v-if="!isLoggedIn" class="bg-blue-600 rounded-3xl p-6 text-white shadow-lg shadow-blue-500/20 mb-6">
        <h2 class="text-xl font-black mb-2 leading-tight">Need assistance with your account?</h2>
        <p class="text-blue-50/80 text-sm leading-relaxed mb-4">
      ...
      <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-5">
        ...
        <div class="flex gap-3 flex-wrap">
          <router-link to="/privacy" class="px-4 py-2 rounded-xl border text-blue-700 font-semibold hover:bg-blue-50 transition-colors text-sm">Privacy Policy</router-link>
          <router-link to="/policy" class="px-4 py-2 rounded-xl border text-blue-700 font-semibold hover:bg-blue-50 transition-colors text-sm">Terms of Use</router-link>
        </div>
      </div>
    </div>
  </div>
