      ...
      <div v-else>
        ...
        <div class="bg-gradient-to-br from-blue-700 to-blue-900 rounded-[2rem] p-6 text-white shadow-xl">
          ...
          <div class="mt-4 grid grid-cols-2 gap-2">
            <div>
              <p v-if="project?.target_amount" class="text-blue-100 text-[11px]">Target: ₦ {{ Number(project.target_amount).toLocaleString() }}</p>
            ...
            <div v-for="p in profits" :key="p.id" class="p-4">
              ...
              <div class="mt-2 text-[12px]">
                ...
                <div class="flex items-center justify-between mt-1">
                  ...
                  <span v-if="p.my_payout" class="font-bold text-blue-700">₦ {{ Number(p.my_payout.amount).toLocaleString() }}</span>
        ...
        <div class="p-6 space-y-6 text-slate-800">
          <div class="bg-blue-50 rounded-3xl p-4 flex items-center justify-between border border-blue-100">
             <div>
                ...
                <p class="text-2xl font-black text-blue-900">₦ {{ Number(project.unit_price).toLocaleString() }}</p>
             </div>
